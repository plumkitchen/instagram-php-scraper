...
class Endpoints
{
    ...
    const ACCOUNT_MEDIAS = 'https://www.instagram.com/graphql/query';
    ...
    const ACCOUNT_JSON_INFO = 'https://i.instagram.com/api/v1/users/web_profile_info/?username={username}';
    ...
    public static function getAccountMediasJsonLink()
    {
        return static::ACCOUNT_MEDIAS;
    }
